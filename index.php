...
$sql=mysqli_query($con,"select id from lusers where email='$email'");
$row=mysqli_num_rows($sql);
if($row>0)
{
	echo "<script>alert('Email id already exist with another account. Please try with other email id');</script>";
} else{
	$msg=mysqli_query($con,"insert into lusers(fname,lname,email,password,contactno) values('$fname','$lname','$email','$enc_password','$contact')");
...
$ret= mysqli_query($con,"SELECT * FROM lusers WHERE email='$useremail' and password='$dec_password'");
...
<div class="main">
		<h2> LOGIN</h2>
	 <div class="sap_tabs">	
			<div id="horizontalTab" style="display: block; width: 100%; margin-top: 15px; ">
